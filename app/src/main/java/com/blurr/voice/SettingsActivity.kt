...
class SettingsActivity : BaseNavigationActivity() {
    ...
    companion object {
        ...
        private const val TEST_TEXT = "Hello, I'm Miko, and this is a test of the selected voice."
    ...
    private fun initialize() {
        ...
        availableVoices = DeepgramTts.getAvailableVoices()
    ...
    private fun cacheVoiceSamples() {
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            for (voice in availableVoices) {
                ...
                if (!voiceFile.exists()) {
                    try {
                        val audioData = DeepgramTts.synthesize(TEST_TEXT, voice)
