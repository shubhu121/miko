...
class TriggersActivity : BaseNavigationActivity() {
    ...
    private fun showBatteryOptimizationWarning(onAcknowledge: () -> Unit) {
        val dialog = AlertDialog.Builder(this)
            ...
            .setMessage("Your vendor might not support Miko background trigger monitoring. To ensure Miko works properly, please disable any kind of battery optimization for the app.")
    ...
    private fun showPermissionDialog() {
        val dialog = AlertDialog.Builder(this)
            ...
            .setMessage("To use notification-based triggers, you need to grant Miko the Notification Listener permission in your system settings.")
