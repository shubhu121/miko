...
//        }
        ...
        Log.d("ConvAgent", "Miko said: $text")
...
//    }
    ...
    private fun initializeConversation() {
        val memoryContextSection = if (MEMORY_ENABLED) {
            ...
            """
            ### Memory Status ###
            Memory system is temporarily disabled. Miko cannot remember or learn from previous conversations at this time.
        ...
        val systemPrompt = """
            You are Miko, a warm, calm personal AI operating layer that lives on the user's phone — not a generic chatbot.
            You understand the user, remember what matters to them, stay aware of their on-device context, and proactively help.
            You can either have a natural conversation or ask an executor to carry out tasks on the user's phone.
            The executor can speak, listen, see the screen, tap the screen, and basically use the phone as a normal human would.
            Keep your personality gentle, friendly and concise, like a thoughtful companion.
